...
-- Creación de la Base de Datos y limpieza preventiva
...
-- PASO 2: Definición del Esquema (DDL) y Restricciones de Integridad
...
CREATE TABLE productos (
    ...
    stock INT DEFAULT 0,
    activo INT DEFAULT 1, -- Usamos INT compatible con la lógica booleana/TINYINT
    CONSTRAINT PK_productos PRIMARY KEY (id_producto),
    CONSTRAINT FK_productos_categorias FOREIGN KEY (id_categoria) 
        REFERENCES categorias (id_categoria)
);

-- 4. Tabla: ventas (Tabla de Hechos Central)
CREATE TABLE ventas (
    id_venta INT,
...
-- PASO 3: Carga Inicial de Datos (DML)
...
-- PASO 4: Consultas de Verificación de Integridad
